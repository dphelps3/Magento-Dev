...
Product.ConfigurableSwatchesQV.prototype = {
    ...
    setStockData: function() {
        var cartBtn = $$('#iwd-qv-wrapper .add-to-cart');
        this._E.cartBtn = {
            btn: cartBtn,
            txt: cartBtn.invoke('readAttribute', 'title'),
            onclick: cartBtn.length ? cartBtn[0].getAttribute('onclick') : ''
        };
        this._E.availability = $$('#iwd-qv-wrapper p.availability');
    ...
    setStockStatus: function(inStock) {
        if (inStock) {
            ...
            this._E.cartBtn.btn.each(function(el) {
                ...
                el.writeAttribute('title', Translator.translate('Add to Cart'));
                el.select('span span').invoke('update', Translator.translate('Add to Cart'));
            }.bind(this));
        } else {
            this._E.availability.each(function(el) {
                var el = $(el);
