<?php
class IWD_QuickView_Block_System_Config_Form_Fieldset_Extensions extends Mage_Adminhtml_Block_System_Config_Form_Field
{
	protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        $available = Mage::helper('iwd_quickview')->isAvailableVersion();
        $version = Mage::getConfig()->getModuleConfig("IWD_QuickView")->version;
