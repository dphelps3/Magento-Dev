...
class DecHardware_DecHardwareProduct_Block_Adminhtml_Catalog_Product_Tab
...
implements Mage_Adminhtml_Block_Widget_Tab_Interface {
    ...
    public function _construct()
    {
        ...
        $this->setTemplate('dechardwareproduct/catalog/product/tab.phtml');
