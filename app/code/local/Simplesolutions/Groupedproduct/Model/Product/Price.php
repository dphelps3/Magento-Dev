...
class Simplesolutions_Groupedproduct_Model_Product_Price
extends Mage_Catalog_Model_Product_Type_Price
{
    ...
    public function getFinalPrice($qty=null, $product)
    {
        ...
        if ($product->hasCustomOptions())
        {
            ...
            $associatedProducts = $typeInstance->setStoreFilter($product->getStore(), $product)->getGroupedProducts($product);
