<?php
class Simplesolutions_Cabinetproduct_Model_Product_Price extends Mage_Catalog_Model_Product_Type_Price
{
    /**
    ...
    public function getFinalPrice($qty=null, $product)
    {
        ...
        Mage::dispatchEvent('catalog_product_type_cabinet_price', array('product' => $product));
