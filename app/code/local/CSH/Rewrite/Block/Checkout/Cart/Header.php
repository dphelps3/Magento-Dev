 ...
 *
 * Moved file from app/code/local/Mage/Checkout/Block/Cart/Header.php
 */
class CSH_Rewrite_Block_Checkout_Cart_Header extends Mage_Checkout_Block_Cart_Abstract
{
