...
class Mage_Catalog_Model_Category extends Mage_Catalog_Model_Abstract
{
    ...
    public function getCategoryIdUrl()
    {
        ...
        $params = array('s' => $urlKey, 'id' => $this->getId());
        if ($this->_noSid === true) {
            $params['_nosid'] = true;
        }
        $url = $this->getUrlInstance()->getUrl('catalog/category/view', $params);
...
//        }
     ...
     * @return Mage_Catalog_Model_Category
     */
    public function setNoSid($flag)
    {
        $this->_noSid = (bool) $flag;
        return $this;
    }
}
