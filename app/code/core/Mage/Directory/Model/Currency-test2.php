...
class Mage_Directory_Model_Currency extends Mage_Core_Model_Abstract
{
    ...
    */
    ...
    {
		$price=$this->formatPrecision($price, 4, $options, $includeContainer, $addBrackets);
		if (self::EndsWith($price,'0')===1) {
			$price=$this->formatPrecision($price, 3, $options, $includeContainer, $addBrackets);
		}
		if (self::EndsWith($price,'0')) {
			$price=$this->formatPrecision($price, 2, $options, $includeContainer, $addBrackets);
		}
	    return $price;//$this->formatPrecision($price, 4, $options, $includeContainer, $addBrackets);
    }
